...
use App\Infrastructure\Http\EventController; // Use DDD EventController
...
Route::group(['middleware' => 'auth'], function() {
   ...
   // Route::get('/dashboard', [DashboardController::class, 'DashboardPage'])->name('home');
    ...
    Route::get('/eventPage', [EventController::class, 'EventPage']); // DDD EventController
    ...
    // Event API - Now using DDD EventController
